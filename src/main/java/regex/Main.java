...
public class Main {
     ...
     * Only addresses ending with "@mail.utoronto.ca" or "@utoronto.ca"
     * and with at least one character before "@" are included.
     ...
     * For example "Amazing Apple" contains "A" twice.
